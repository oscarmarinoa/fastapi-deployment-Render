...
class Tsunamis(Base):
    ...
    idtsunamis = Column(Integer, primary_key=True, index = True) # No se le pone idtsunamis
    idpais = Column(Integer, ForeignKey('pais.idpais'))
...
class Volcanes(Base):
    ...
    idvolcanes = Column(Integer, primary_key=True, index = True) # No se le pone idvolcanes
    idpais = Column(Integer, ForeignKey('pais.idpais'))
